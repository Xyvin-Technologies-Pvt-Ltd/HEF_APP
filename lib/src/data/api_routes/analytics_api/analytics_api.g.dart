...
String _$downloadAnalyticsProviderHash() =>
    r'479fe58a211bdeb209913ff794bc824280463e6e';

/// New Riverpod provider for download analytics
///
/// Copied from [downloadAnalyticsProvider].
@ProviderFor(downloadAnalyticsProvider)
final downloadAnalyticsProviderProvider =
    AutoDisposeFutureProvider<Map<String, dynamic>?>.internal(
  downloadAnalyticsProvider,
  name: r'downloadAnalyticsProviderProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$downloadAnalyticsProviderHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef DownloadAnalyticsProviderRef
